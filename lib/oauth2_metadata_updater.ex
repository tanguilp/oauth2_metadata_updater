defmodule Oauth2MetadataUpdater do
  ...
  - `resolve_jwks`: automatically resolves the `jwks_uri` and fetches the JSON Web Keys. Defaults to `true`
  ...
  - `ssl_jwks`: Erlang client SSL options for the HTTP request to the JWKs. Defaults to `[]`
  ...
  @doc """
  Returns `{:ok, map_of_jwks_keys}` of the of an issuer, or `{:error, error}` if it could not be
  retrieved or if validation failed.
